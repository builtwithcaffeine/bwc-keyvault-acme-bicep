# Deploy Microsoft Graph Users Module
...
Write-Host "🚀 Deploying Microsoft Graph Users Module..." -ForegroundColor Green
...
try {
    ...
    # Deploy the module
    $deploymentName = "users-deployment-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
    ...
    if ($WhatIf) {
        ...
        if ($result.ProvisioningState -eq "Succeeded") {
            ...
            Write-Host "  User ID: $($result.Outputs.userId.Value)" -ForegroundColor White
            Write-Host "  User Principal Name: $($result.Outputs.userPrincipalName.Value)" -ForegroundColor White
            Write-Host "  Display Name: $($result.Outputs.displayName.Value)" -ForegroundColor White
            Write-Host "  Mail: $($result.Outputs.mail.Value)" -ForegroundColor White
