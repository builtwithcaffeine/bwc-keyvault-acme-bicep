# Deploy Microsoft Graph Service Principals Module
...
Write-Host "🚀 Deploying Microsoft Graph Service Principals Module..." -ForegroundColor Green
...
try {
    ...
    # Deploy the module
    $deploymentName = "service-principals-deployment-$(Get-Date -Format 'yyyyMMdd-HHmmss')"
    ...
    if ($WhatIf) {
        ...
        if ($result.ProvisioningState -eq "Succeeded") {
            ...
            Write-Host "  Service Principal ID: $($result.Outputs.servicePrincipalId.Value)" -ForegroundColor White
            Write-Host "  App ID: $($result.Outputs.appId.Value)" -ForegroundColor White
